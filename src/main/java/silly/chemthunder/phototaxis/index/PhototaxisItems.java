...
public interface PhototaxisItems {
    ...
    Item MOTH = create("moth", new MothItem(new AcornItemSettings()
            .showHand()
            .maxCount(1)
    ));

    Item JAR = create("jar", new JarItem(new Item.Settings()
            .maxCount(16)
    ));
    ...
    Item LUNAR_TOTEM = create("lunar_totem", new LunarTotemItem(new Item.Settings()
            .maxCount(1)
            .fireproof()
    ));
